...
var PAT_UIF_MAP = {
  ...
  'DATA-02': { tip:'T-00', desc:'Calidad del dato: la totalidad del período corresponde a movimientos entre cuentas del propio titular, sin contrapartes de terceros que analizar' },
