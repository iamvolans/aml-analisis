...
import { LayoutDashboard, FolderOpen, BarChart3, Bell, Briefcase, CalendarClock, ShieldCheck, Share2, FileBarChart, Scale, Radar, BookOpen, Users, Download, Upload, Settings, LogOut, Sun, Moon } from "lucide-react";
...
var ComiteView = lazy(function(){ return import("./views/Comite"); });
    ...
    <div style={{display:'flex',height:'100vh',overflow:'hidden',fontFamily:T.MONO,background:T.BG,color:T.TEXT}}>
      ...
      <div style={{flex:1,overflowY:'auto',maxHeight:'100vh',background:T.BG}}>
        ...
        <Suspense fallback={<CargandoVista/>}>
          ...
          {view==='analisis' ? <AnalisisView casos={casos} setCasos={setCasos} onSyncCasos={syncCasos} legajos={legajos} periodos={periodos} setPeriodos={setPeriodos} onReport={function(html){setReportHTML(html);}} initLegajo={analTarget.leg} initPeriodo={analTarget.per} onSync={syncToCloud} currentUser={currentUser}/> : null}
